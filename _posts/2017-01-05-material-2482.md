...
- What are methods commonly used to heat treat steel and what result do they produce?
    ...
    - normalizing (above UCT)
        - air cooled, minimum time for carbon diffusion
...
- What is the function of a penetrameter in radiography?
    - penetrameter is the device used to establish the quality of a radiograph
...
- _What is the anodic reaction when steel is exposed to aerated dilute H2SO4?  What are the cathodic reactions?_
    - anodic reaction: $$Fe \to Fe^{2^+} + 2e^-$$
    - cathodic reaction:  $$2H^{+} + 2e \to H_2 (gas)$$

- What is meant by corrosion allowance?
    - an added additional thickness compensate for corrosion
...
- _What happens when a zinc block is fastened to a steel structure that is exposed to aerated fresh water?_
...
- What is meant by the term crevice corrosion?  What conditions must be present for this type of attack to occur?
    - crevice or gasket corrosion induced in gaps and cracks where electrolyte get into
...
- What is stress corrosion cracking?  
    - metal failure due to combined effects of corrosion (metal + corrosive env) and stress (external or residual)

- What is used in domestic water heaters to cathodically protect them?
    - sacrificial anode is used in a domestic hot water heater
