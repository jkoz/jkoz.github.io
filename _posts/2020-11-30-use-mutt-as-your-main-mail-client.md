...
Below command will list all mail boxes under your account folder with the depth of 5. I use sed to make the output of find command look nicer. The output will be piped to fzf for selection. Again, I use sed to parse result from fzf to something mutt can understand (e.i push c=[Gmail]/Ibox)
